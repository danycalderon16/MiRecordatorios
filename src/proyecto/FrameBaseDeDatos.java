 ...
 * @author Calderon
 */
public class FrameBaseDeDatos extends javax.swing.JFrame {

    /**
     * Creates new form FrameBaseDeDatos
     */
    public FrameBaseDeDatos() {
        initComponents();
        toolbar1.setTitle("Base de Datos");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameBaseDeDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameBaseDeDatos().setVisible(true);
            }
        });
    }
